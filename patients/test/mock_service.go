...
func (mr *MockServiceMockRecorder) AddProviderConnectionRequest(ctx, clinicId, userId, request interface{}) *gomock.Call {
...
func (mr *MockServiceMockRecorder) AddReview(ctx, clinicId, userId, review interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) DeleteReview(ctx, clinicId, clinicianId, userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) RescheduleLastSubscriptionOrderForPatient(ctx, clinicIds, userId, subscription, ordersCollection, targetCollection interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
