...
//
//	mockgen --build_flags=--mod=mod -source=./patients.go -destination=./test/mock_service.go -package test MockService
//
...
func (mr *MockServiceMockRecorder) AddReview(ctx, clinicId, userId, review any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddReview", reflect.TypeOf((*MockService)(nil).AddReview), ctx, clinicId, userId, review)
}
...
func (mr *MockServiceMockRecorder) Count(ctx, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) Create(ctx, patient any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) DeleteFromAllClinics(ctx context.Context, userId string, metadata deletions.Metadata) ([]string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) DeleteFromAllClinics(ctx, userId, metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteFromAllClinics", reflect.TypeOf((*MockService)(nil).DeleteFromAllClinics), ctx, userId, metadata)
}

// DeleteNonCustodialPatientsOfClinic mocks base method.
func (m *MockService) DeleteNonCustodialPatientsOfClinic(ctx context.Context, clinicId string, metadata deletions.Metadata) error {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) DeleteNonCustodialPatientsOfClinic(ctx, clinicId, metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteNonCustodialPatientsOfClinic", reflect.TypeOf((*MockService)(nil).DeleteNonCustodialPatientsOfClinic), ctx, clinicId, metadata)
}
...
func (mr *MockServiceMockRecorder) DeletePatientTagFromClinicPatients(ctx, clinicId, tagId, patientIds any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) DeletePermission(ctx, clinicId, userId, permission any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) DeleteReview(ctx context.Context, clinicId, clinicianId, userId string) ([]patients.Review, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) Get(ctx, clinicId, userId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) Remove(ctx, clinicId, userId, metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Remove", reflect.TypeOf((*MockService)(nil).Remove), ctx, clinicId, userId, metadata)
}
...
func (mr *MockServiceMockRecorder) RescheduleLastSubscriptionOrderForAllPatients(ctx, clinicId, subscription, ordersCollection, targetCollection any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) RescheduleLastSubscriptionOrderForPatient(ctx context.Context, clinicIds []string, userId, subscription, ordersCollection, targetCollection string) error {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) RescheduleLastSubscriptionOrderForPatient(ctx, clinicIds, userId, subscription, ordersCollection, targetCollection any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) TideReport(ctx, clinicId, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) UpdateEHRSubscription(ctx, clinicId, userId, update any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) UpdateLastUploadReminderTime(ctx, update any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) UpdatePatientDataSources(ctx, userId, dataSources any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) UpdateSummaryInAllClinics(ctx, userId, summary any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
