...
func (m *MockRepository) AddProviderConnectionRequest(ctx context.Context, clinicId, userId string, request patients.ConnectionRequest) (*patients.Patient, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) AddProviderConnectionRequest(ctx, clinicId, userId, request interface{}) *gomock.Call {
...
func (mr *MockRepositoryMockRecorder) AddReview(ctx, clinicId, userId, review interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) AssignPatientTagToClinicPatients(ctx, clinicId, tagId, patientIds interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) DeleteFromAllClinics(ctx, userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) DeleteNonCustodialPatientsOfClinic(ctx, clinicId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) DeletePatientTagFromClinicPatients(ctx, clinicId, tagId, patientIds interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) DeleteReview(ctx, clinicId, clinicianId, userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Remove(ctx, clinicId, userId, deletedByUserId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) RescheduleLastSubscriptionOrderForPatient(ctx, clinicIds, userId, subscription, ordersCollection, targetCollection interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Update(ctx, update interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
