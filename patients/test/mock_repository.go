...
func (m *MockRepository) RescheduleLastSubscriptionOrderForPatient(ctx context.Context, clinicIds []string, patientId, subscription, ordersCollection, targetCollection string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RescheduleLastSubscriptionOrderForPatient", ctx, clinicIds, patientId, subscription, ordersCollection, targetCollection)
	ret0, _ := ret[0].(error)
	return ret0
}

// RescheduleLastSubscriptionOrderForPatient indicates an expected call of RescheduleLastSubscriptionOrderForPatient.
func (mr *MockRepositoryMockRecorder) RescheduleLastSubscriptionOrderForPatient(ctx, clinicIds, patientId, subscription, ordersCollection, targetCollection interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RescheduleLastSubscriptionOrderForPatient", reflect.TypeOf((*MockRepository)(nil).RescheduleLastSubscriptionOrderForPatient), ctx, clinicIds, patientId, subscription, ordersCollection, targetCollection)
}
