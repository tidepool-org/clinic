...
//
//	mockgen -source=./users.go -destination=./test/mock_users.go -package test
//
...
func (mr *MockUserServiceMockRecorder) CreateCustodialAccount(ctx, patient any) *gomock.Call {
...
func (m *MockUserService) DeleteUserAccount(ctx context.Context, userId string) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserServiceMockRecorder) DeleteUserAccount(ctx, userId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteUserAccount", reflect.TypeOf((*MockUserService)(nil).DeleteUserAccount), ctx, userId)
}
...
func (mr *MockUserServiceMockRecorder) GetUserProfile(ctx, userId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserServiceMockRecorder) PopulatePatientDetailsFromExistingUser(ctx, patient any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserServiceMockRecorder) UpdateCustodialAccount(ctx, patient any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
