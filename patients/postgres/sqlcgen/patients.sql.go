...
const insertPatientConnectionRequest = `-- name: InsertPatientConnectionRequest :exec
...
func (q *Queries) InsertPatientConnectionRequest(ctx context.Context, arg InsertPatientConnectionRequestParams) error {
	_, err := q.db.Exec(ctx, insertPatientConnectionRequest, arg.PatientID, arg.ProviderName, arg.CreatedTime)
	return err
}

const insertPatientDataSource = `-- name: InsertPatientDataSource :exec
...
func (q *Queries) InsertPatientDataSource(ctx context.Context, arg InsertPatientDataSourceParams) error {
	_, err := q.db.Exec(ctx, insertPatientDataSource,
		arg.PatientID,
		arg.Ordinal,
		arg.ProviderName,
		arg.State,
...
const insertPatientEHRSubscription = `-- name: InsertPatientEHRSubscription :exec
...
func (q *Queries) InsertPatientEHRSubscription(ctx context.Context, arg InsertPatientEHRSubscriptionParams) error {
	_, err := q.db.Exec(ctx, insertPatientEHRSubscription,
		arg.PatientID,
		arg.Name,
		arg.Provider,
		arg.Active,
...
const insertPatientEHRSubscriptionMatchedMessage = `-- name: InsertPatientEHRSubscriptionMatchedMessage :exec
...
func (q *Queries) InsertPatientEHRSubscriptionMatchedMessage(ctx context.Context, arg InsertPatientEHRSubscriptionMatchedMessageParams) error {
	_, err := q.db.Exec(ctx, insertPatientEHRSubscriptionMatchedMessage,
		arg.PatientID,
...
const insertPatientReview = `-- name: InsertPatientReview :exec
...
func (q *Queries) InsertPatientReview(ctx context.Context, arg InsertPatientReviewParams) error {
	_, err := q.db.Exec(ctx, insertPatientReview,
		arg.PatientID,
		arg.Ordinal,
		arg.ClinicianID,
		arg.ReviewTime,
...
const insertPatientSite = `-- name: InsertPatientSite :exec
INSERT INTO patient_sites (patient_id, site_id, site_name)
VALUES ($1, $2, $3)
...
func (q *Queries) InsertPatientSite(ctx context.Context, arg InsertPatientSiteParams) error {
	_, err := q.db.Exec(ctx, insertPatientSite, arg.PatientID, arg.SiteID, arg.SiteName)
	return err
}

const insertPatientTag = `-- name: InsertPatientTag :exec
INSERT INTO patient_tags (patient_id, tag_id)
VALUES ($1, $2)
ON CONFLICT DO NOTHING
`
...
func (q *Queries) InsertPatientTag(ctx context.Context, arg InsertPatientTagParams) error {
	_, err := q.db.Exec(ctx, insertPatientTag, arg.PatientID, arg.TagID)
	return err
}
