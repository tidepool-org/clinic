...
type DeviceIssuesV1 struct {
	Disconnected                DeviceIssuesDisconnectedV1                `json:"disconnected,omitempty,omitzero"`
...
// DeviceIssuesDisconnectedV1 defines model for .
type DeviceIssuesDisconnectedV1 struct {
