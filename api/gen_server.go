...
type ServerInterface interface {
	...
	// Patient Invitation Re-sent
	// (POST /v1/clinics/{clinicId}/patients/{patientId}/invitation_resent)
	MarkPatientInvitationResent(ctx echo.Context, clinicId ClinicId, patientId PatientId) error
...
// MarkPatientInvitationResent converts echo context to params.
func (w *ServerInterfaceWrapper) MarkPatientInvitationResent(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "clinicId" -------------
	var clinicId ClinicId
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.MarkPatientInvitationResent(ctx, clinicId, patientId)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.POST(baseURL+"/v1/clinics/:clinicId/patients/:patientId/invitation_resent", wrapper.MarkPatientInvitationResent)
