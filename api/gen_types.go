...
// Valid indicates whether the value is a known member of the ClinicV1ClinicSize enum.
func (e ClinicV1ClinicSize) Valid() bool {
	switch e {
	case N0249:
		return true
	case N1000:
...
// Valid indicates whether the value is a known member of the ClinicV1ClinicType enum.
func (e ClinicV1ClinicType) Valid() bool {
	switch e {
	case ClinicV1ClinicTypeHealthcareSystem:
		return true
	case ClinicV1ClinicTypeOther:
		return true
	case ClinicV1ClinicTypeProviderPractice:
		return true
	case ClinicV1ClinicTypeResearcher:
		return true
	case ClinicV1ClinicTypeVeterinaryClinic:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ClinicV1PreferredBgUnits enum.
func (e ClinicV1PreferredBgUnits) Valid() bool {
	switch e {
	case ClinicV1PreferredBgUnitsMgdL:
		return true
	case ClinicV1PreferredBgUnitsMmolL:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ClinicTimezoneV1 enum.
func (e ClinicTimezoneV1) Valid() bool {
	switch e {
	case AfricaAbidjan:
		return true
	case AfricaAccra:
	...
	case AmericaArgentinaCatamarca:
		return true
	case AmericaArgentinaComodRivadavia:
		return true
	...
	case AmericaElSalvador:
		return true
	case AmericaEnsenada:
		return true
	case AmericaFortNelson:
		return true
	case AmericaFortWayne:
		return true
	...
	case AustraliaPerth:
		return true
	case AustraliaQueensland:
		return true
	case AustraliaSouth:
		return true
	case AustraliaSydney:
		return true
	case AustraliaTasmania:
		return true
	case AustraliaVictoria:
		return true
	case AustraliaWest:
		return true
	case AustraliaYancowinna:
		return true
	case BrazilAcre:
		return true
	case BrazilDeNoronha:
		return true
	case BrazilEast:
		return true
	case BrazilWest:
	...
	case CanadaMountain:
		return true
	case CanadaNewfoundland:
		return true
	case CanadaPacific:
		return true
	case CanadaSaskatchewan:
		return true
	case CanadaYukon:
		return true
	case ChileContinental:
		return true
	case ChileEasterIsland:
		return true
	case Cuba:
		return true
	case EET:
...
// Valid indicates whether the value is a known member of the DataSourceV1State enum.
func (e DataSourceV1State) Valid() bool {
	switch e {
	case Connected:
		return true
	case Disconnected:
...
// Valid indicates whether the value is a known member of the DiagnosisTypeV1 enum.
func (e DiagnosisTypeV1) Valid() bool {
	switch e {
	case DiagnosisTypeV1Empty:
		return true
...
// Valid indicates whether the value is a known member of the EhrMatchMessageRefV1DataModel enum.
func (e EhrMatchMessageRefV1DataModel) Valid() bool {
	switch e {
	case Order:
		return true
	default:
...
// Valid indicates whether the value is a known member of the EhrMatchMessageRefV1EventType enum.
func (e EhrMatchMessageRefV1EventType) Valid() bool {
	switch e {
	case EhrMatchMessageRefV1EventTypeNew:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the EhrMatchRequestPatientsOptionsV1Criteria enum.
func (e EhrMatchRequestPatientsOptionsV1Criteria) Valid() bool {
	switch e {
	case DOBFULLNAME:
		return true
	case MRN:
...
// Valid indicates whether the value is a known member of the EhrMatchRequestPatientsOptionsV1OnUniqueMatch enum.
func (e EhrMatchRequestPatientsOptionsV1OnUniqueMatch) Valid() bool {
	switch e {
	case DISABLEREPORTS:
		return true
	case ENABLEREPORTS:
...
// Valid indicates whether the value is a known member of the EhrSettingsV1Provider enum.
func (e EhrSettingsV1Provider) Valid() bool {
	switch e {
	case Redox:
		return true
	case Xealth:
...
// Valid indicates whether the value is a known member of the GlycemicRangesV1Type enum.
func (e GlycemicRangesV1Type) Valid() bool {
	switch e {
	case Custom:
		return true
	case Preset:
...
// Valid indicates whether the value is a known member of the GlycemicRangesPresetV1 enum.
func (e GlycemicRangesPresetV1) Valid() bool {
	switch e {
	case ADAHighRisk:
		return true
	case ADAPregnancyType1:
		return true
	case ADAPregnancyType2:
		return true
	case ADAStandard:
		return true
	default:
...
// Valid indicates whether the value is a known member of the GlycemicRangesThresholdUpperBoundV1Units enum.
func (e GlycemicRangesThresholdUpperBoundV1Units) Valid() bool {
	switch e {
	case GlycemicRangesThresholdUpperBoundV1UnitsMgdL:
		return true
	case GlycemicRangesThresholdUpperBoundV1UnitsMmolL:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MigrationStatusV1 enum.
func (e MigrationStatusV1) Valid() bool {
	switch e {
	case COMPLETED:
		return true
	case PENDING:
...
// Valid indicates whether the value is a known member of the ProviderIdV1 enum.
func (e ProviderIdV1) Valid() bool {
	switch e {
	case Abbott:
		return true
	case Dexcom:
...
// Valid indicates whether the value is a known member of the ScheduledReportsV1Cadence enum.
func (e ScheduledReportsV1Cadence) Valid() bool {
	switch e {
	case DISABLED:
		return true
	case N14d:
...
// Valid indicates whether the value is a known member of the ScheduledReportsV1OnUploadNoteEventType enum.
func (e ScheduledReportsV1OnUploadNoteEventType) Valid() bool {
	switch e {
	case ScheduledReportsV1OnUploadNoteEventTypeNew:
		return true
	case ScheduledReportsV1OnUploadNoteEventTypeReplace:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the TierV1 enum.
func (e TierV1) Valid() bool {
	switch e {
	case Tier0100:
		return true
	case Tier0200:
...
// Valid indicates whether the value is a known member of the TideReportParamsCategories enum.
func (e TideReportParamsCategories) Valid() bool {
	switch e {
	case DropInTimeInTargetPercent:
		return true
	case MeetingTargets:
		return true
	case TimeCGMUsePercent:
		return true
	case TimeInAnyHighPercent:
		return true
	case TimeInAnyLowPercent:
		return true
	case TimeInExtremeHighPercent:
		return true
	case TimeInTargetPercent:
		return true
	case TimeInVeryHighPercent:
		return true
	case TimeInVeryLowPercent:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the FindPatientsParamsWorkspaceIdType enum.
func (e FindPatientsParamsWorkspaceIdType) Valid() bool {
	switch e {
	case FindPatientsParamsWorkspaceIdTypeClinicId:
		return true
	case FindPatientsParamsWorkspaceIdTypeEhrSourceId:
		return true
	default:
		return false
	}
...
type BgmPeriodV1 struct {
	...
	// StandardDeviation Example: 2.5
	StandardDeviation *float64 `json:"standardDeviation,omitempty"`

	// StandardDeviationDelta Example: 2.5
...
type CgmPeriodV1 struct {
	...
	// HoursWithData Example: 2
	HoursWithData int `json:"hoursWithData"`

	// HoursWithDataDelta Example: 2
...
type CreatePatientV1 struct {
	...
	// BirthDate Example: 2012-08-30
	BirthDate *openapi_types.Date `json:"birthDate,omitempty"`

	// DiagnosisType Example: type1
	...
	Tags        *PatientTagIdsV1      `json:"tags,omitempty"`
}
...
type DataSourceV1 struct {
	...
	// ProviderName Example: dexcom
	ProviderName ProviderNameV1 `json:"providerName"`

	// State Example: connected
	State DataSourceV1State `json:"state"`
}

// DataSourceV1State Example: connected
...
type ErrorV1 struct {
	...
	// Message Example: Requested resources was not found
...
type PatientV1 struct {
	...
	CreatedTime        *time.Time                    `json:"createdTime,omitempty"`
	DataSources        *[]DataSourceV1               `json:"dataSources,omitempty"`
	...
	Mrn         *string               `json:"mrn,omitempty"`
	Permissions *PatientPermissionsV1 `json:"permissions,omitempty"`
	Reviews     []PatientReviewV1     `json:"reviews,omitempty"`
	Sites       []SiteV1              `json:"sites,omitzero"`
...
// PhoneNumberV1 Example: {"number":"+1 (555) 555-1212","type":"main"}
...
type TideReportParams struct {
	...
	Categories []TideReportParamsCategories `form:"categories,omitempty" json:"categories,omitempty,omitzero"`
	...
	Sites *[]ObjectIdV1 `form:"sites,omitempty" json:"sites,omitempty,omitzero"`
}
