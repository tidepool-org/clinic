...
generate:
	...
	oapi-codegen -include-tags="Orders (Healthsystem)",Webhooks -package=xealth_client -generate=types,skip-prune ../TidepoolApi/reference/xealth.v2.yaml > xealth_client/gen_types.go
	oapi-codegen -include-tags="Orders (Healthsystem)" -package=xealth_client -generate=client ../TidepoolApi/reference/xealth.v2.yaml > xealth_client/gen_client.go
	go generate ./...
