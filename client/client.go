...
type ClientInterface interface {
	...
	// ListSitesWithBody request with any body
	ListSitesWithBody(ctx context.Context, clinicId ClinicId, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	ListSites(ctx context.Context, clinicId ClinicId, body ListSitesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) ListSitesWithBody(ctx context.Context, clinicId ClinicId, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewListSitesRequestWithBody(c.Server, clinicId, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ListSites(ctx context.Context, clinicId ClinicId, body ListSitesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewListSitesRequest(c.Server, clinicId, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewListSitesRequest calls the generic ListSites builder with application/json body
func NewListSitesRequest(server string, clinicId ClinicId, body ListSitesJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewListSitesRequestWithBody(server, clinicId, "application/json", bodyReader)
}

// NewListSitesRequestWithBody generates requests for ListSites with any type of body
func NewListSitesRequestWithBody(server string, clinicId ClinicId, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// ListSitesWithBodyWithResponse request with any body
	ListSitesWithBodyWithResponse(ctx context.Context, clinicId ClinicId, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ListSitesResponse, error)

	ListSitesWithResponse(ctx context.Context, clinicId ClinicId, body ListSitesJSONRequestBody, reqEditors ...RequestEditorFn) (*ListSitesResponse, error)
...
// ListSitesWithBodyWithResponse request with arbitrary body returning *ListSitesResponse
func (c *ClientWithResponses) ListSitesWithBodyWithResponse(ctx context.Context, clinicId ClinicId, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ListSitesResponse, error) {
	rsp, err := c.ListSitesWithBody(ctx, clinicId, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) ListSitesWithResponse(ctx context.Context, clinicId ClinicId, body ListSitesJSONRequestBody, reqEditors ...RequestEditorFn) (*ListSitesResponse, error) {
	rsp, err := c.ListSites(ctx, clinicId, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseListSitesResponse(rsp)
